...
type valueComparatorAlters func(field string, matcherValue string) string

func baseComparatorAlters(field string, matcherValue string) string {
	switch {
...
type valueModifierAlters func(next valueComparatorAlters) valueComparatorAlters

var modifiersAlters = map[string]valueModifierAlters{
	"contains": func(_ valueComparatorAlters) valueComparatorAlters {
	...
	"endswith": func(_ valueComparatorAlters) valueComparatorAlters {
		return func(field string, matcherValue string) string {
			// The Sigma spec defines that by default comparisons are case-insensitive
			return fmt.Sprintf("%v like '%%%v'", strings.ToLower(field), strings.ToLower(matcherValue))
		}
	},
	"startswith": func(_ valueComparatorAlters) valueComparatorAlters {
		return func(field string, matcherValue string) string {
			// The Sigma spec defines that by default comparisons are case-insensitive
			return fmt.Sprintf("%v like '%v%%'", strings.ToLower(field), strings.ToLower(matcherValue))
		}
	},
	"base64": func(next valueComparatorAlters) valueComparatorAlters {
		return func(field string, matcherValue string) string {
			return fmt.Sprintf("%v base64 '%v'", strings.ToLower(field), matcherValue)
		}
	},
	"re": func(_ valueComparatorAlters) valueComparatorAlters {
		return func(field string, matcherValue string) string {
			return fmt.Sprintf("%v re '%v'", strings.ToLower(field), matcherValue)
		}
	},
	"cidr": func(_ valueComparatorAlters) valueComparatorAlters {
		return func(field string, matcherValue string) string {
			return fmt.Sprintf("%v cidr '%v'", strings.ToLower(field), matcherValue)
		}
	},
	"gt": func(_ valueComparatorAlters) valueComparatorAlters {
		return func(field string, matcherValue string) string {
			return fmt.Sprintf("%v > '%v'", strings.ToLower(field), strings.ToLower(matcherValue))
		}
	},
	"gte": func(_ valueComparatorAlters) valueComparatorAlters {
		return func(field string, matcherValue string) string {
			return fmt.Sprintf("%v >= '%v'", strings.ToLower(field), strings.ToLower(matcherValue))
		}
	},
	"lt": func(_ valueComparatorAlters) valueComparatorAlters {
		return func(field string, matcherValue string) string {
			return fmt.Sprintf("%v < '%v'", strings.ToLower(field), strings.ToLower(matcherValue))
		}
	},
	"lte": func(_ valueComparatorAlters) valueComparatorAlters {
		return func(field string, matcherValue string) string {
			return fmt.Sprintf("%v <= '%v'", strings.ToLower(field), strings.ToLower(matcherValue))
		}
	},
