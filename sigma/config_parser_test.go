...
// TestParseConfig walks through the testdata directory and looks for all files with a .config.yml extension.
...
func TestParseConfig(t *testing.T) {
	// Walk through the "testdata/" directory and its subdirectories recursively.
